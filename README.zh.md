...
> **没有轨迹,就没有丰容。** 一段从未经历真实运行的 skill,永远长不大。
...
> ### ⟁ 学术来源声明
>
> 本 skill **不是独立原创方法**,而是论文 EmbodiSkill 的工程化移植。
>
...
>
> **使用本 skill 即视为同意**:若在学术或商业场景中引用本 skill,需同时引用原论文。
...
<sub>✦ 本 README 采用 *Field Guide*(园丁手记)美学——向 19 世纪博物学家野外图鉴传统致敬。✦</sub>
